...
class LupaSandiNotifier extends ChangeNotifier {
  ...
  simpan() async {
    ...
    AuthRepository.cekLupaPassword(token, NetworkURL.cekLupaPassword(),
            usersId.text.trim(), noRek.text.trim(), noHp.text.trim())
        .then((value) {
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "Mohon masukan MPIN kamu untuk validasi ganti sandi",
                    style: TextStyle(
                      fontFamily: "Satoshi",
                      fontSize: 16,
                    ),
