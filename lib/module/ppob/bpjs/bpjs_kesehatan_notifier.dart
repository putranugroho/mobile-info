...
class BPJSKesehatanNotifier extends ChangeNotifier {
                            ...
                            children: [
                              InkWell(
                                onTap: () {
                                  ...
                                  bulanResult = no;
                                  bulan.text = DateFormat('MMMM y').format(
                                ...
                                child: Container(
                                  ...
                                  child: Text(
                                      "${DateFormat('MMMM y').format(DateTime(now.year, now.month + i))}"),
                                ),
                              ),
                              (no == 12)
                                  ? SizedBox()
  ...
  simpan() async {
    ...
    IakRepository.checkBPJS(token, NetworkURL.checkBillBPJS(), "BPJS",
            bulanResult.toString(), hp.text.trim())
        .then((value) {
      Navigator.pop(context);
