...
import 'package:mobile_info/module/ppob/e_toll/e_toll_notifier.dart';
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: 16),
                      Text("E-Toll", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                    ],
                  ),
                ),
                Expanded(
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              Text("${value.streamingModel!.nama} ${value.prabayarModel!.pulsaNominal}"),
                                            ],
                                          ),
                                          SizedBox(height: 4),
                                          Row(
                                            children: [
                                              ...
                                              Text("${FormatCurrency.oCcy.format(value.prabayarModel!.pulsaPrice)}"),
                                            ],
                                          ),
                                          SizedBox(height: 16),
                                          Text("Nomor Kartu", style: TextStyle(fontSize: 12)),
                                          SizedBox(height: 4),
                                          TextFormField(
                                            controller: value.hp,
                                  ...
                                  : Column(
                                      ...
                                      children: [
                                        ...
                                        value.listPrabayarResult.isNotEmpty
                                            ? ListView.builder(
                                                itemCount: value.listPrabayarResult.length,
                                                shrinkWrap: true,
                                                physics: ClampingScrollPhysics(),
                                                itemBuilder: (context, i) {
                                                  final data = value.listPrabayarResult[i];
                                                  return Column(
                                                    crossAxisAlignment: CrossAxisAlignment.stretch,
                                                    children: [
                                                      InkWell(
                                                        onTap: () => value.pili(data),
                                                        child: Container(
                                                          ...
                                                          child: Column(
                                                            crossAxisAlignment: CrossAxisAlignment.stretch,
                                                            children: [
                                                              Text("${data.pulsaNominal}", style: TextStyle(fontSize: 12)),
                                                              SizedBox(height: 4),
                                                              Text(
