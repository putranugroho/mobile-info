...
class EwalletNotifier extends ChangeNotifier {
  ...
  Future getPascabayar() async {
    isLoading = true;
    notifyListeners();
    IakRepository.pascabayar(token, NetworkURL.pascabayar(), "emoney")
        .then((value) {
      if (value['value'] == 1) {
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                              "Rp. ${FormatCurrency.oCcy.format(value['data']['data']['nominal'])}")
                        ],
                      ),
                      SizedBox(
                        height: 4,
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                              "Rp. ${FormatCurrency.oCcy.format(value['data']['data']['admin'] + 200)}")
                        ],
                      ),
                      SizedBox(
                        height: 4,
                      ...
                      ButtonPrimary(
                        onTap: () {
                          Navigator.pop(context);
                          pinTransaksi(
                              value['data']['data']['tr_id'].toString(),
