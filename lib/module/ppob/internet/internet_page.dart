...
import 'package:mobile_info/module/ppob/internet/internet_notifier.dart';
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: 16),
                      Text("Internet", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                    ],
                  ),
                ),
                Expanded(
                          ...
                          : Container(
                              ...
                              child: Form(
                                ...
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.stretch,
                                  children: [
                                    Text("Internet Provider", style: TextStyle(fontSize: 12)),
                                    SizedBox(height: 4),
                                    InkWell(
                                      ...
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(hintText: "Pilih Provider"),
                                      ),
                                    ),
                                    SizedBox(height: 16),
