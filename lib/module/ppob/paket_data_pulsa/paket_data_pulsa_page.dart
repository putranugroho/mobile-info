...
import 'package:ibpr/module/ppob/paket_data_pulsa/paket_data_pulsa_notifier.dart';
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              value.page == 1
                                  ...
                                  : ListView.builder(
                                      itemCount:
                                          value.listPaketDataResult.length,
                                      shrinkWrap: true,
                                      physics: ClampingScrollPhysics(),
                                      itemBuilder: (context, i) {
                                        final data =
                                            value.listPaketDataResult[i];
                                        return Column(
                                          crossAxisAlignment:
