...
class PascabayarNotifier extends ChangeNotifier {
  ...
  simpan() async {
    ...
    IakRepository.checkBPJS(token, NetworkURL.checkBillBPJS(), "PASCABAYAR", "", hp.text.trim()).then((value) {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text("Rp. ${FormatCurrency.oCcy.format(value['data']['nominal'] + 200)}"),
                    ],
                  ),
                  SizedBox(height: 4),
                  Row(
                    children: [
                      ...
                      Text("Rp. ${FormatCurrency.oCcy.format(value['data']['admin'])}"),
                    ],
                  ),
                  SizedBox(height: 4),
                  Row(
