...
import 'package:mobile_info/module/ppob/streaming/streaming_notifier.dart';
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: 16),
                      Text("Streaming", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                    ],
                  ),
                ),
                Expanded(
                                            ...
                                            children: [
                                              ...
                                              Container(
                                                ...
                                                child: Column(
                                                  crossAxisAlignment: CrossAxisAlignment.stretch,
                                                  children: [
                                                    Text("${value.prabayarModel!.pulsaNominal}", style: TextStyle(fontSize: 12, color: Colors.white)),
                                                    SizedBox(height: 4),
                                                    Text(
                                              ...
                                              SizedBox(height: 16),
                                              Text("Customer ID / Nomor Pelanggan", style: TextStyle(fontSize: 12)),
                                              SizedBox(height: 4),
                                              TextFormField(
                                                validator: (e) {
                                                  if (e!.isEmpty) {
