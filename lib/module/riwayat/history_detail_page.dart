...
import 'package:ibpr/module/riwayat/history_detail_notifier.dart';
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Image.asset(ImageAssets.logo, height: 90),
                                    Image.network(
                                      "${value.users!.bprLogo}",
                                      height: 40,
                                    ),
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 4),
                                      Text(
                                        "${DateFormat('dd MMM y HH:mm').format(DateTime.parse(model.createdDate))}",
                                        style: TextStyle(),
                                      ),
                                      SizedBox(height: 8),
                                      Container(
                                              ...
                                              children: [
                                                ...
                                                Row(
                                                  children: [
                                                    ...
                                                    Text(
                                                      "${model.keterangan == 'IN' ? 'Topup' : 'Transfer'}",
                                                    ),
                                                  ],
                                                ),
                                                Container(
                                                    ...
                                                    children: [
                                                      ...
                                                      Row(
                                                        children: [
                                                          ...
                                                          Text(
                                                            "${FormatCurrency.oCcy.format(int.parse(value.toObject['nominal'].toString()))}",
                                                          ),
                                                        ],
                                                      ),
                                                      SizedBox(height: 4),
                                                      Row(
                                                        children: [
                                                          ...
                                                          Text(
                                                            "${FormatCurrency.oCcy.format(int.parse(value.toObject['admin'].toString()))}",
                                                          ),
                                                        ],
                                                      ),
                                                      SizedBox(height: 4),
                                                      Row(
                                                        children: [
                                                          ...
                                                          Text(
                                                            "${FormatCurrency.oCcy.format(int.parse(value.toObject['price'].toString()))}",
                                                          ),
                                                        ],
                                                      ),
                                                    ],
                                                        ...
                                                        onPressed: () async {
                                                          await Clipboard.setData(
                                                            ...
                                                            ScaffoldMessenger.of(
                                                              ...
                                                              SnackBar(
                                                                content: Text(
                                                                  "Token listrik berhasil di copy",
                                                                ),
                                                              ),
                                                            );
                                                          });
                                                        ...
                                                        onPressed: () async {
                                                          await Clipboard.setData(
                                                            ...
                                                            ScaffoldMessenger.of(
                                                              ...
                                                              SnackBar(
                                                                content: Text(
                                                                  "Virtual Account berhasil di copy",
                                                                ),
                                                              ),
                                                            );
                                                          });
