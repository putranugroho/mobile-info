...
import 'package:ibpr/models/history_model.dart';
import 'package:ibpr/module/repository/auth_repository.dart';
import 'package:ibpr/module/repository/transfer_repository.dart';
...
class TransferConfirmationNotifier extends ChangeNotifier {
  ...
  TransferConfirmationNotifier(
      this.context, this.nama, this.account, this.code, this.bankName) {
    getProfile();
  }
